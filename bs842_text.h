...
bsint_function void CreateTextBitmap(unsigned char *result, stbtt_fontinfo *fontInfo, char *text, bsint_f32 lineHeight, bsint_s32 textSizeX, bsint_f32 *charX)
{
...
bsint_function void DrawTextBitmap(void *buffer, unsigned char *textBitmap, bsint_u32 colour, bsint_f32 charX, bsint_f32 xPosPercent, bsint_f32 yPosPercent, bsint_s32 textSizeX, bsint_s32 textSizeY)
{
    Text_BackBuffer *backBuffer = (Text_BackBuffer *)buffer;
    CHECK_TEXT_BACKBUFFER(backBuffer);
    
    bsint_s32 xPos = bs842_internal_RoundF32ToS32(backBuffer->width * xPosPercent) - ((bsint_s32)charX / 2);
    bsint_s32 yPos = bs842_internal_RoundF32ToS32(backBuffer->height * yPosPercent) - (textSizeY / 2);
...
bsint_function void DrawTextBitmap(void *buffer, unsigned char *textBitmap, bsint_u32 colour1, bsint_u32 colour2, bsint_s32 colourChangeX, bsint_f32 charX,
...
bsint_function void DrawBasicTextElement(void *buffer, stbtt_fontinfo *fontInfo, bsint_f32 sizeRatio, bsint_f32 xPosPercent, bsint_f32 yPosPercent, bsint_s32 textSizeX, bsint_f32 lineHeight, char *text, bsint_u32 colour)
{
    Text_BackBuffer *backBuffer = (Text_BackBuffer *)buffer;
    CHECK_TEXT_BACKBUFFER(backBuffer);
